...
const schema = yup.object({
    ...
    orgPhoneNumber: yup.string().matches(staticData.phoneRegExp, "Некорректный номер телефона").required(),
...
const TemplateFill: FC = () => {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        setLoading(true);
        try {
            const response = await fetch('http://localhost:3001/api/generatedocument', {
                method: 'POST',
